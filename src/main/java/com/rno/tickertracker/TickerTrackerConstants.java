...
public class TickerTrackerConstants {

    public static String WEBDRIVER_TO_USE = "chrome";
    public static String JACOB_DLL_FILE_X86 = "src/test/resources/AutoItX3/jacob-1.18-x86.dll";
    public static String JACOB_DLL_FILE_X64 = "src/test/resources/AutoItX3/jacob-1.18-x64.dll";
    public static String PATH_TO_CHROMEDRIVER_X86 = "src/test/resources/webdriver/win32/chromedriver99.exe";
    public static String PATH_TO_CHROMEDRIVER_X64 = "src/test/resources/webdriver/win32/chromedriver99.exe";
    public static String PATH_TO_GECKO_X64 = "src/test/resources/webdriver/win32/geckodriver30.exe";


    // selenium /    pokpok!pokpok!!!
